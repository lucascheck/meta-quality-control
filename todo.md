...
- [ ] Interface elegante, sofisticada, responsiva, acessível e com estados de loading/erro/vazio
- [ ] Testes Vitest para isolamento de credenciais, regras de tier, normalização de status e disparo
...
- [ ] Calcular uso e percentual consumido com dados reais quando disponíveis
- [x] Permitir múltiplos destinatários com resultado individual
- [ ] Atualizar status real de entrega por webhook ou sincronização de status
- [ ] Adicionar estados explícitos de loading e erro nas áreas principais
- [ ] Criar testes de isolamento, disparo e restrição dos tiers suportados
- [ ] Validar fluxos críticos de sucesso e erro no navegador
